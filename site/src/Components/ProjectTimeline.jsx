    ...
    render() {
        return (
            <Timeline>
                ...
                <Timeline.Item dot={<Icon type="profile" style={{fontSize: '20px'}} />}>
                <p><strong>Dec:</strong> 2nd Progress Update</p>
                </Timeline.Item>
                <Timeline.Item dot={<Icon type="book" style={{fontSize: '20px'}}/>}>
                <p><strong>March 2019:</strong> Technical Report</p>
                </Timeline.Item>
                <Timeline.Item color='blue' dot={<Icon type="rocket" style={{fontSize: '20px'}}/>}>
