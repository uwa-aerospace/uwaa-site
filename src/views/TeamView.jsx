...
export default class TeamView extends Component {
    render() {
        return (
            <Container fluid id='team-container'>
                <Segment 
                    inverted
                    textAlign='center'
                ...
                <Grid  centered stackable relaxed='very'>
                    <GridRow style={{marginTop: '6em', marginBottom: '3em'}}>
                        <Container text>
                            ...
                            <h3>UWA Aerospace is a multidisciplinary team of undergraduate and postgraduate students studying at the University of Western Australia. 
                            Our team is primarily comprised of mechanical, software and electrical engineers.</h3>
                            <br/>
                            <Button color='blue' content='Apply Now!' size='large' href='https://forms.gle/XBN4GzdspLjGJt1p7' as='a' target='_blank' />
                        </Container> 
                    </GridRow>
